...
// Curated themes and premium mood bundles; the wizard's "palette" step is really "theme" picker.
...
export const THEMES: readonly Theme[] = [
  ...
  // Premium mood bundles inspired by modern theme browsers.
  {
    key: "modern-minimal",
    name: "Modern Minimal",
    description: "White space, crisp type, and a quiet black accent for premium service sites.",
    paletteKey: "alpine-clean",
    fontPairKey: "manrope-inter",
    radius: "modest",
    typeRatio: "cozy",
  ...
  },
  {
    key: "vercel-mono",
    name: "Vercel Mono",
    description: "High-contrast monochrome for modern agencies, SaaS, and technical studios.",
  ...
  },
  {
    key: "sage-garden",
    name: "Sage Garden",
    description: "Soft green, editorial type, and calm cards for wellness and boutique brands.",
  ...
  },
  {
    ...
    name: "Elegant Luxury",
    description:
      "Champagne warmth with refined serif headings for property, events, and premium services.",
  ...
  },
  {
    key: "ocean-breeze",
    name: "Ocean Breeze",
    description: "Fresh blue, generous spacing, and soft confidence for trust-led businesses.",
  ...
  },
  {
    key: "nature",
    name: "Nature",
    description: "Deep green and warm editorial typography for organic, calm, human brands.",
  ...
  },
  {
    key: "graphite-mono",
    name: "Graphite Mono",
    description: "Neutral graphite, restrained borders, and pure Inter for professional websites.",
  ...
  },
  {
    ...
    name: "Clean Slate",
    description:
      "Cool Swiss blue-gray with modern type for agencies, software, and local services.",
    paletteKey: "zurich-modern",
    fontPairKey: "manrope-inter",
    radius: "modest",
    typeRatio: "cozy",
  ...
  },
  {
    key: "solar-dusk",
    name: "Solar Dusk",
    description: "Golden warmth and characterful headings for events, hospitality, and launches.",
    paletteKey: "ticino-sun",
    fontPairKey: "fraunces-inter",
    radius: "rounded",
    typeRatio: "airy",
  ...
  },
  {
    key: "amber-slate",
    name: "Amber Slate",
    description: "Swiss utility with a warm amber accent for trades and serious local services.",
    paletteKey: "bern-heritage",
    fontPairKey: "ibm-plex-source-serif",
    radius: "sharp",
    typeRatio: "compact",
