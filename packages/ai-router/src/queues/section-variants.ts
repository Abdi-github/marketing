...
export const SECTION_VARIANTS = {
  ...
  about: ["text-image-split", "team-grid", "values-3col", "trust-proof"],
  menu_preview: ["list-borders", "cards-grid", "split-image"],
  offer: ["banner-centered", "split-image-price", "countdown-bold", "quote-path"],
  gallery: ["masonry-3", "grid-2x2", "carousel-strip", "feature-side", "portfolio-bento"],
  ...
  lead_form: ["card-centered", "split-side-image", "full-width-bar", "consultation-panel"],
