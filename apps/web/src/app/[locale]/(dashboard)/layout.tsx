...
export default async function DashboardLayout({ children, params }: Props) {
  ...
  const groups = [
    ...
    },
    {
      ...
      items: [
        ...
        { href: `/${locale}/sequences`, label: t("sequences"), icon: "M13 10V3L4 14h7v7l9-11h-7z" },
        {
          href: `/${locale}/sms-automation`,
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-gray-50">
      <Sidebar locale={locale} logoutLabel={t("logout")} brandName={t("brand")} groups={groups} />
      {/* Main content — scrollable, takes remaining space */}
      <div className="flex min-w-0 flex-1 flex-col overflow-y-auto pl-0 lg:pl-0">
        {/* Mobile top spacer to avoid hamburger overlap */}
