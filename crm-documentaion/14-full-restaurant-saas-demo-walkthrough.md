...
| 5    | Social post designed graphic generated a completed state, but the preview image rendered as broken and the browser console showed a 404 for a UUID-like resource. Fix started immediately: social post UI/API should use the stable `/api/social-creatives/{jobId}/image` route instead of trusting stored public creative URLs.                                                                                            | Blocking  | 2026-07-06 social graphic screenshot + console | Fix now           |
